...
public class MultiThreadedRandomlyPartitionedBenchmarkTask<T extends Comparable<T>> extends RandomlyPartitionedBenchmarkTask<T> {
     ...
     */
    public MultiThreadedRandomlyPartitionedBenchmarkTask(final int numThreads) {
        super();
    ...
    public String toString() {
        return "Multi-" + this.threads + ", random pivot";
    }
